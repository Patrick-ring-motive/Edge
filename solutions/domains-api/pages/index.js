...
export default function Home() {
  ...
  return ( <
    ...
    /> <
    a href = "https://github.com/vercel/examples/tree/main/solutions/domains-api"
    target = "_blank"
    rel = "noreferrer"
    ...
    required className = "rounded-md border border-gray-300 focus:ring-0 focus:border-black px-4 flex-auto min-w-0 sm:text-sm" /
    >
    <
    button type = "submit"
    disabled = {
