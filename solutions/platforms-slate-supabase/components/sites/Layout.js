...
export default function Layout({
  ...
  return ( <
      ...
      /> {
      subdomain != 'demo' && < meta name = "robots"
      content = "noindex" / >
    } <
    /Head> <
  div className = {
    ...
    div className = "flex justify-center items-center space-x-5 h-full max-w-screen-xl mx-auto px-10 sm:px-20" > {
      subdomain == 'demo' ? ( <
        ...
        /span> < /
        Link > <
        a href = "https://www.producthunt.com/posts/platforms-starter-kit?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-platforms-starter-kit"
        target = "_blank"
        rel = "noreferrer"
        className = "mt-1 sm:block hidden flex-shrink-0" >
        <
        Image src = "https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=327608&theme=light"
...

  {
    subdomain == 'demo' && ( <
      ...
      /a> <
      a href = "https://vercel.com/guides/nextjs-multi-tenant-application"
      target = "_blank"
      rel = "noreferrer"
