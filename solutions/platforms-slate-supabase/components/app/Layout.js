...
export default function Layout({
  ...
  if (!session) return < Loader / >
    ...
    return ( <
      ...
      <
      button className = "text-gray-500 hover:text-gray-700 transition-all ease-in-out duration-150"
      onClick = {
        () => signOut()
      } >
      Logout <
      /button> <
      /div> <
      a href = "https://github.com/vercel/platforms"
      target = "_blank"
      rel = "noreferrer"
