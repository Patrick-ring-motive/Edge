...
export default function AppSettings() {
  ...
  return ( <
    ...
    <
    input className = "w-full px-5 py-3 font-cal text-gray-700 bg-white border-none focus:outline-none focus:ring-0 rounded-none rounded-lg placeholder-gray-400"
    type = "text"
    name = "name"
